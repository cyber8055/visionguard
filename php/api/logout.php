...
// We just need a valid token to log out, role doesn't matter for the logout action itself
$token = '';
...
if (empty($token)) {
    echo json_encode(['success' => true]); // Just return success if no token is found
    exit;
}
